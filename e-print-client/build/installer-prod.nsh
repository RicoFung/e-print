...
!macro customUnInstall
  ...
  DeleteRegValue HKCU "Software\Microsoft\Windows\CurrentVersion\Run" "electron.app.EPrintClient"
  DeleteRegValue HKCU "Software\Microsoft\Windows\CurrentVersion\Run" "electron.app.E Print Client"
  DeleteRegValue HKLM "Software\Microsoft\Windows\CurrentVersion\Run" "electron.app.${PRODUCT_NAME}"
  DeleteRegValue HKLM "Software\Microsoft\Windows\CurrentVersion\Run" "electron.app.EPrintClient"
  DeleteRegValue HKLM "Software\Microsoft\Windows\CurrentVersion\Run" "electron.app.E Print Client"
!macroend
