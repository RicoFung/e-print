package com.eprint.server.module.minio.template.controller;

import com.eprint.server.module.minio.template.service.MinioTemplateService;
...
@Tag(name = "template")
@RestController
@RequestMapping("/minio/template")
public class MinioTemplateController extends BaseRestController {
